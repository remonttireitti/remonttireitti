...
export async function createContractorListing(
  ...
  try {
    ...
    if (billing === "subscription") {
      ...
      if (error) {
        console.error("[createContractorListing] subscription insert", error.code, error.message);
    ...
    if (listErr || !listing) {
      console.error("[createContractorListing] single insert", listErr?.code, listErr?.message);
