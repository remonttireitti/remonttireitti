...
AIRFI_CONNECT_TIMEOUT_SEC = float(os.environ.get("AIRFI_CONNECT_TIMEOUT_SEC", "3"))
AIRFI_READ_TIMEOUT_SEC = float(os.environ.get("AIRFI_READ_TIMEOUT_SEC", "3"))
AIRFI_RETRY_COUNT = max(0, int(os.environ.get("AIRFI_RETRY_COUNT", "3")))
AIRFI_RETRY_DELAY_SEC = float(os.environ.get("AIRFI_RETRY_DELAY_SEC", "1.0"))
AIRFI_OFFLINE_BACKOFF_MAX_SEC = float(os.environ.get("AIRFI_OFFLINE_BACKOFF_MAX_SEC", "60"))
AIRFI_OFFLINE_SKIP_AFTER = max(1, int(os.environ.get("AIRFI_OFFLINE_SKIP_AFTER", "5")))
AIRFI_CACHE_MAX_AGE_SEC = float(os.environ.get("AIRFI_CACHE_MAX_AGE_SEC", "300"))
