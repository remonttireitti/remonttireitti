-- Julkinen palaute: vieraskäyttäjät, sähköpostivahvistus, tukipyynnöt.
...
DROP POLICY IF EXISTS "platform_feedback_support: insert own feedback" ON public.platform_feedback_support_requests;
...
DROP POLICY IF EXISTS "platform_feedback_support: admin read" ON public.platform_feedback_support_requests;
