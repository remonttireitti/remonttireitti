-- Asiakkaan urakoitsijasuosittelu (ajetaan customer referrals -migraation jälkeen).
...
DROP POLICY IF EXISTS "customer_contractor_referrals: admin read" ON public.customer_contractor_referrals;
...
DROP POLICY IF EXISTS "customer_contractor_referrals: referrer read own" ON public.customer_contractor_referrals;
